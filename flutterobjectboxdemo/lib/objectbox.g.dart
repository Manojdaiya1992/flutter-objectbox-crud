...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 8327855911941927623),
      name: 'User',
      lastPropertyId: const IdUid(4, 2130646495207596642),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 7941039358384954804),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8852707861416690382),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 1462315286323757960),
            name: 'mobile',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 2130646495207596642),
            name: 'age',
            type: 6,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 8327855911941927623),
...
class User_ {
  ...
  /// see [User.mobile]
  static final mobile = QueryStringProperty<User>(_entities[0].properties[2]);
